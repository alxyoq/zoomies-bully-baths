    ...
    <section className="py-16 bg-light-blue" ref={sectionRef}>
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <motion.h2
            className="text-2xl sm:text-3xl font-pacifico text-white mb-6"
          ...
          <motion.p
            className="text-base sm:text-xl text-white mb-8"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
          ...
          >
            ...
            >
              <Link
                href="/contact"
                className="relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-bone hover:bg-opacity-90 text-[#46aebe] font-bold rounded-full transition-all"
              >
                <motion.span
